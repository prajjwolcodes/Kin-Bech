    ...
    <div className="min-h-screen bg-gray-50">
                ...
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                    <Avatar className="h-8 w-8">
                      <AvatarImage src="/placeholder-admin.jpg" alt={user?.name} />
                      <AvatarFallback>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Manage and monitor the entire KinBech platform</p>
        </div>
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{platformAnalytics.totalUsers.toLocaleString()}</div>
                  <p className="text-xs text-muted-foreground">+{platformAnalytics.newUsersThisMonth} this month</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{platformAnalytics.totalOrders.toLocaleString()}</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">${platformAnalytics.totalRevenue.toLocaleString()}</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">${platformAnalytics.platformCommission.toLocaleString()}</div>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>New buyers and sellers joining the platform</CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Latest user registrations and orders</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center space-x-4 p-3 bg-green-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">New seller registered: Sarah Wilson</p>
                  ...
                  <div className="flex items-center space-x-4 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">Large order completed: $299.99</p>
                  ...
                  <div className="flex items-center space-x-4 p-3 bg-yellow-50 rounded-lg">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">User reported issue: Payment failed</p>
          ...
          <TabsContent value="users" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <Card>
                <CardContent className="p-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-blue-600">{platformAnalytics.totalBuyers}</p>
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-purple-600">{platformAnalytics.totalSellers}</p>
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-green-600">{platformAnalytics.activeUsers}</p>
                        ...
                        <TableCell>
                          <div className="text-sm">
                            {user.role === "buyer" ? (
                              ...
                              <>
                                <p>{user.productsListed} products</p>
          ...
          <TabsContent value="orders" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <Card>
                <CardContent className="p-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-gray-900">{mockAllOrders.length}</p>
              ...
              <Card>
                <CardContent className="p-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-yellow-600">
                      {mockAllOrders.filter((o) => o.status === "pending").length}
                    </p>
                ...
                <CardContent className="p-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-blue-600">
                      {mockAllOrders.filter((o) => o.status === "shipped").length}
                    </p>
                ...
                <CardContent className="p-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold text-green-600">
                      {mockAllOrders.filter((o) => o.status === "delivered").length}
                    </p>
                  ...
                  <TableBody>
                    {filteredOrders.map((order) => (
                      <TableRow key={order.id}>
                        ...
                        <TableCell className="font-semibold text-green-600">${order.commission}</TableCell>
                        <TableCell>
          ...
          <TabsContent value="analytics" className="space-y-6">
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Platform-wide category performance</CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Key metrics and recommendations for platform growth</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start space-x-3 p-4 bg-green-50 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-semibold text-green-800">Strong Platform Growth</h4>
                      <p className="text-sm text-green-700">
                        Platform revenue has grown by 15% this month. Electronics category is leading with 40% of total
                        sales.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-semibold text-blue-800">User Acquisition Success</h4>
                      <p className="text-sm text-blue-700">
                        156 new users joined this month, with a healthy 7:1 buyer to seller ratio. Consider seller
                        incentive programs.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3 p-4 bg-yellow-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700">
                        4 sellers are pending approval and 2 users have been suspended. Review these cases for platform
                        quality.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3 p-4 bg-purple-50 rounded-lg">
                    ...
                    <div>
                      <h4 className="font-semibold text-purple-800">Commission Optimization</h4>
                      <p className="text-sm text-purple-700">
                        Current 10% commission rate is generating $
                        {platformAnalytics.platformCommission.toLocaleString()} monthly. Consider tiered commission
                        structure for high-volume sellers.
                      </p>
                    </div>
                  </div>
                </div>
