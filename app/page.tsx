...
export default function KinBechLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              {/* Stats */}
              <motion.div
                className="grid grid-cols-2 lg:grid-cols-4 gap-8 pt-8 border-t border-gray-200"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
                variants={{
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <Card className="group hover:shadow-xl transition-all duration-300 border-2 border-gray-100 hover:border-blue-200 bg-white">
      ...
      <section className="bg-white lg:grid lg:h-[1/2] lg:place-content-center dark:bg-gray-900">
        <div className="mx-auto w-screen max-w-screen-2xl px-4 py-16 sm:px-6 sm:py-16 md:grid md:grid-cols-2 md:items-center md:gap-4 lg:px-8 lg:36 lg:my-16">
          {/* Left content */}
          <motion.div
          ...
          >
            ...
            >
              We help you find all at one place and help{" "}
              <strong className="text-indigo-600"> increase </strong> sales
            </motion.h1>
            ...
            >
              Our platform offers a comprehensive solution to streamline your
              sales process and improve customer engagement.
            </motion.p>
          ...
          {/* Right content - you can drop your SVG here */}
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
